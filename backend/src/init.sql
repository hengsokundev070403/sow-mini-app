...
('en-GB', 'business_name_placeholder', 'Business name'),
('sv-SE', 'business_name_placeholder', 'Företagsnamn'),
('en-GB', 'contact_person_placeholder', 'Contact Person'),
('sv-SE', 'contact_person_placeholder', 'Kontaktperson'),
('en-GB', 'address_placeholder', 'Address'),
('sv-SE', 'address_placeholder', 'Adress'),
('en-GB', 'postal_number_placeholder', 'Postal number'),
('sv-SE', 'postal_number_placeholder', 'Postnummer'),
('en-GB', 'city_placeholder', 'City'),
('sv-SE', 'city_placeholder', 'Ort'),
('en-GB', 'email_address_placeholder', 'Email address'),
('sv-SE', 'email_address_placeholder', 'E-postadress'),
('en-GB', 'phone_number_placeholder', 'Phone number'),
('sv-SE', 'phone_number_placeholder', 'Telefonnummer'),
('en-GB', 'choose_password_placeholder', 'Choose Password'),
('sv-SE', 'choose_password_placeholder', 'Välj lösenord'),
('en-GB', 'invoice_now_btn', 'Invoice Now'),
('sv-SE', 'invoice_now_btn', 'Fakturera nu'),
...
('sv-SE', 'reg_info_terms_accept', 'Klicka på Fakturera nu för att börja fakturera och godkänna villkoren. Din första faktura är normalt redo att skickas inom 5 - 10 minuter.'),
('en-GB', 'terms_link', 'terms'),
('sv-SE', 'terms_link', 'villkor'),
