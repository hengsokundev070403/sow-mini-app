  ...
  return (
    <div className="sidebar-container">
      <h3 className="sidebar-title">
        {translation[TRANSLATION_KEYS.MENU.TITLE]}
      </h3>
        ...
        <nav className="sidebar-menu">
          <NavLink to="/invoices" className="sidebar-menu-item">
            ...
            <span className="sidebar-text">
              {translation[TRANSLATION_KEYS.MENU.INVOICES]}
            </span>
          </NavLink>
          <NavLink to="/customers" className="sidebar-menu-item">
            ...
            <span className="sidebar-text">
              {translation[TRANSLATION_KEYS.MENU.CUSTOMERS]}
            </span>
          </NavLink>
          <NavLink to="/my-business" className="sidebar-menu-item">
            ...
            <span className="sidebar-text">
              {translation[TRANSLATION_KEYS.MENU.MY_BUSINESS]}
            </span>
          </NavLink>
          <NavLink to="/invoice-journal" className="sidebar-menu-item">
            ...
            <span className="sidebar-text">
              {translation[TRANSLATION_KEYS.MENU.INVOICE_JOURNAL]}
            </span>
          </NavLink>
          <NavLink to="/price-list" className="sidebar-menu-item">
            ...
            <span className="sidebar-text">
              {translation[TRANSLATION_KEYS.MENU.PRICE_LIST]}
            </span>
          </NavLink>
          <NavLink to="/multiple-invoicing" className="sidebar-menu-item">
            ...
            <span className="sidebar-text">
              {translation[TRANSLATION_KEYS.MENU.MULTIPLE_INVOICING]}
            </span>
          </NavLink>
          <NavLink to="/unpaid-invoices" className="sidebar-menu-item">
            ...
            <span className="sidebar-text">
              {translation[TRANSLATION_KEYS.MENU.UNPAID_INVOICES]}
            </span>
          </NavLink>
          <NavLink to="/offer" className="sidebar-menu-item">
            ...
            <span className="sidebar-text">
              {translation[TRANSLATION_KEYS.MENU.OFFER]}
            </span>
          </NavLink>
          <NavLink to="/inventory-control" className="sidebar-menu-item">
            ...
            <span className="sidebar-text">
              {translation[TRANSLATION_KEYS.MENU.INVENTORY_CONTROL]}
            </span>
          </NavLink>
          <NavLink to="/member-invoicing" className="sidebar-menu-item">
            ...
            <span className="sidebar-text">
              {translation[TRANSLATION_KEYS.MENU.MEMBER_INVOICING]}
            </span>
          </NavLink>
          ...
          <a href="#" className="sidebar-menu-item">
            ...
            <span className="sidebar-text">
              {translation[TRANSLATION_KEYS.MENU.LOG_OUT]}
            </span>
          </a>
        </nav>
      </div>
